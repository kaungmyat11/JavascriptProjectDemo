...
<body>
    ...
    <?php
            ...
            {
                echo("<div class='error' role='alert'>Your confirmation code is empty! Enter your code!</div>");
            }
            else if(strpos($fullURL, "code=wrong") == true)
            {
                echo("<div class='error' role='alert'>Your confirmation code is wrong! Check your code!</div>");
            }
    ?> 
